const Logo = () => {
    return (
        ...
        >
            <defs>
                <linearGradient
                    id="b7709055-0dd4-48d6-ac10-5a758f15d1a1-204"
                    x1="443.56"
                    y1="792.13"
                    x2="443.56"
                    y2="251.5"
            ...
            <path
                ...
                opacity="0.1"
            />
            <ellipse cx="313.7" cy="714.18" rx="33.8" ry="6.5" fill="#e11d48" />
            <ellipse
                cx="313.13"
                cy="711.42"
                rx="3.94"
            ...
            <path
                ...
                transform="translate(-59 -87.5)"
                fill="url(#b7709055-0dd4-48d6-ac10-5a758f15d1a1-204)"
            />
            <path
            ...
            <path
                ...
                transform="translate(-59 -87.5)"
                fill="url(#f59ba046-7ebe-407e-be3d-c62856fc1078-205)"
            />
            <path
            ...
            <path
                ...
                fill="#f75842"
            />
            <circle cx="473" cy="60" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="520" cy="195" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="387" cy="67" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="172" cy="386" r="18" fill="#e11d48" opacity="0.1" />
            <circle cx="897" cy="100" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="905" cy="195" r="23" fill="#e11d48" opacity="0.1" />
            <circle cx="942" cy="130" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="880" cy="258" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="459" cy="116" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="197" cy="470" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="186" cy="310" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="570" cy="53" r="7" fill="#e11d48" opacity="0.1" />
            <circle cx="593" cy="116" r="7" fill="#e11d48" opacity="0.1" />
        </svg>
    );
};
